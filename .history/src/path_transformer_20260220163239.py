...
class PathTransformer:
    ...
    def normalize(self, absolute_path: str, source_device: Optional[str] = None) -> str:
        ...
        Args:
            absolute_path: Caminho absoluto Windows (ex: C:\\Users\\daniel\\Documents\\projetos\\fcst)
        ...
        Examples:
            >>> transformer.normalize("C:\\Users\\daniel\\Documents\\projetos\\fcst")
            "${PROJECTS}/fcst"
            >>> transformer.normalize("C:\\Users\\daniel\\.claude")
            "${CLAUDE_DIR}"
        """
    ...
    def denormalize(self, template_path: str, target_device: Optional[str] = None) -> str:
        ...
        Returns:
            Caminho absoluto Windows (ex: C:\\Users\\daniel\\Documents\\projetos\\fcst)
